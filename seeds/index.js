...
const seedData = async () => {
	...
	for (let i = 0; i < 50; i++) {
		...
		const camp = new Campground({
			...
			price,
			description:
				"Lorem ipsum dolor sit. Maiores excepturi,possimus officiis corporis placeat quisquam, nulla non eius veritatis quo veniam eaque ullam corrupti recusandae.",
		});
		await camp.save();
	}
};
